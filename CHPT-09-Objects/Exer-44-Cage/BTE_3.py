...
bc = BigCage(3)  
bc.add_animals(wolf, sheep1, sheep2, sheep3, snake)  # raises DangerousAssignmentError

bc2 = BigCage(4)
bc2.add_animals(wolf, sheep1, sheep2, sheep3, snake, parrot)  # raises DangerousAssignmentError too
